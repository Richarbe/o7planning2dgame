...
public class GameSurface extends SurfaceView implements SurfaceHolder.Callback{
    ...
    private void initSoundPool() {
        ...
        //Load the sound background.mp3 into the SoundPool
        this.soundIdBackground = this.soundPool.load(this.getContext(), R.raw.background, 1);

        //Load the sound explosion.wav into the SoundPool
    ...
    public void update() {
        ...
        while (iterator.hasNext()) {
            ...
            if(explosion.isFinish()) {
                //If explosion is finished, remove the current element from the iterator & list.
                iterator.remove();
                continue;
            }
        }
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            while(iterator.hasNext()) {
                ...
                if( chibi.getX() < x && x < chibi.getX() + chibi.getWidth()
                    ...
                    //Remove the current chibi from the iterator and the list.
                    iterator.remove();
